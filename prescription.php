...
$pdf->Ln(10);
$pdf->Cell(55, 5, 'Prescribed Medications', 0, 1);

$pdf->Cell(55, 5, 'Quantity', 0, 0);
$pdf->Cell(58, 5, 'Medication', 0, 0);

$pdf->Cell(55, 5, 'Line item description', 0, 1);
$pdf->Cell(58, 5, $fetch['quantity'], 0, 0);

$pdf->Cell(55, 5,$fetch['presriptions'] , 0, 0);
$pdf->Cell(58, 5, $fetch['how_to_use'] , 0, 1);
